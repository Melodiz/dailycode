...
CSV = _find_csv()
OUT = Path.cwd()
TABLES_TXT = OUT / "stage4_tables.txt"
SUMMARY_JSON = OUT / "stage4_summary.json"
...
# tee printed lines so we can also write them to stage4_tables.txt
_lines = []
def emit(s=""):
    print(s)
    _lines.append(s)
