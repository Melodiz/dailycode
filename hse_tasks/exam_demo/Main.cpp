...
void test3()
{
    TArray tArr;// Ensure TArray has a default constructor
...
void test4()
{
    TArray arr1;// Ensure TArray has a default constructor
    ...
    // test CAO
    TArray arr3;// Ensure TArray has a default constructor
