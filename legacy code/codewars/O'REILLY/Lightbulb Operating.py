...
if __name__ == "__main__":
    ...
    print("The second mission in series is completed? Click 'Check' to earn cool rewards!")
...
def edm_for_max_operating(els, operating):
    data = {}
    on_or_off_info = []
    ...
    for line in els:
        ...
        if number not in on_or_off_info:
            on_or_off_info.append(number)
            try:data[number]=data[number]+time
            except: data[number]            
